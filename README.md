# All in One Accessibility®: Akeneo Bundle
...
- Akeneo PIM Community Edition version ^7.0.0

### Steps

1. Run `composer require skynettechnologies/allinone-accessibility-bundle`

2. Run webpack `yarn run webpack`

3. Register the bundle in the config/bundles.php file
    ```
    return [
         // ...
    ...
    ```
4. Now let's clean your cache and dump your assets:
    ```
